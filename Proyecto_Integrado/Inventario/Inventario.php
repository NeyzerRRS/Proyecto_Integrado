...
<body>
    ...
    <a href="http://localhost/Proyecto_Integrado/Inventario/registrar_producto.php?movimiento=alta&id=NULL"><input type="submit" class="AgregarP" value="Agregar Producto Nuevo"></a>
    <a href="P_Desactivados.php"> <input type="submit" class="AgregarP" value="Productos Desactivados"></a>
    <?php
